public class BooleanExpressionsDemo {
    public static void main(String[] args) {
        boolean isJavaFun = true; // boolean means the variable can only be true or false.
        ...
        System.out.println("Is Java fun? " + isJavaFun); //specified output for each operations
